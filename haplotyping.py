...
print(sys.argv[1])
#print(df1['J_gene'])
#print(new_df[new_df['J_gene']=='IGHJ6\*03'])
#print(df1['J_gene']=='IGHJ6\*02')
...
#J1_seq1=new_df[(new_df['J_gene']=='IGHJ6\*02')& (new_df["UTR_leader"]== seqs[0])]

#J1_seq2=new_df[(new_df['J_gene']=='IGHJ6\*02')& (new_df["UTR_leader"]== seqs[1])]
#J2_seq1=new_df[(new_df['J_gene']=='IGHJ6\*03')& (new_df["UTR_leader"]== seqs[0])]
#J2_seq2=new_df[(new_df['J_gene']=='IGHJ6\*03')& (new_df["UTR_leader"]== seqs[1])]
